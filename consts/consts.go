...
const (
	...
	MinOutput              = 10000            // minOutput is the minimum output amt, post fee. This (plus fees) is also the minimum channel balance
	...
	DualFundFee            = 50
	MaxSendAmt             = ^uint32(0) // maximum amount that can be sent through a chan
