...
func NewMultihopPaymentAckMsg(peerIdx uint32, hHash [20]byte) MultihopPaymentAckMsg {
...
func NewMultihopPaymentSetupMsg(peerIdx uint32, amount int64, hHash [20]byte, nodeRoute [][20]byte, data [32]byte) MultihopPaymentSetupMsg {
...
func NewMultihopPaymentSettleMsg(peerIdx uint32, preImage [32]byte) MultihopPaymentSettleMsg {
